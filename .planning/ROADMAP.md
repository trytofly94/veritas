...
**Plans**: 5 plans
  ...
  - [x] 02-04-PLAN.md — Web upload form + login/logout + static assets (UPLOAD-02, SEC-02)
  - [x] 02-05-PLAN.md — Download ZIP endpoint with VERIFY.md (UPLOAD-03, LEGAL-01)
**UI hint**: yes
...
**Plans**: 2 plans
  - [ ] 03-01-PLAN.md — Auth-gated archive list page (BROWSE-01): server-rendered table with TSA badges, empty state, row navigation
